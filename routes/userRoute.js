...
import { changePassword, changeUserApproval, changeUserStatus, deleteUser, getUser, getUsers, updateUser } from "../controllers/user.js";
import auditLog from "../middlewares/auditLog.js";
import { registerValidator, resetPasswordValidator } from "../validators/userValidator.js";
...
router.put("/change-password", isAuth, auditLog, changePassword);
