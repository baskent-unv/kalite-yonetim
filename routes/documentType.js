...
import { changeDocumentTypeStatus, createDocumentType, deleteDocumentType, getDocumentTypes, updateDocumentType } from "../controllers/documentType.js";
...
router.delete('/delete/:id', isAuth, deleteDocumentType);
